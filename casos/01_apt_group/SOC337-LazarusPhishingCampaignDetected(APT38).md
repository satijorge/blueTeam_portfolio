...
| 00:25:27 | Se descomprime desde PowerShell un archivo llamado `nvidiaupdate.zip` justo después de acceder al sitio web y el parent process es `explorer.exe`, lo cual no es común |
